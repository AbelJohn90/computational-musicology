...
<b>Valence</b> <br>
The feature <span style='color:red'>Valence</span>, which describes how positive a song is, almost halves during his career. This would mean that his songs started becoming less happy and more angry or sad. 
...
CA_CT_1 <- 
    get_tidy_audio_analysis('4KFY4EEv9CN6ivrzD6vEvg') %>% 
...
<b>Breath in Breath Out: Happy</b> <br>


<b>Waves: Sad</b> <br>
We see in the chromogram that the chords F, Bb, Db and C are mostly used. These are chords that are mostly present in sad songs, like Rolling in the Deep from Adele. 
